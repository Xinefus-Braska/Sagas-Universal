...
Items can gain experience/levels? 
"""
import random
from evennia import DefaultScript
from evennia.utils.logger import log_file
from world.combat.combat_rules import combat_action_picker
from world.combat.combat_actions import spawn_combat_action_object
...
class CombatHandler(DefaultScript):
    ...
    def _init_character(self, character):
        ...
        # run initial combat mod calculations
        # add stuff here
    ...
    def at_repeat(self):
        ...
        for character in self.db.characters.values():
            ...
            # call the action we are going to use
